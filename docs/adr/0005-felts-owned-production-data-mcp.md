...
Felts must enforce an explicit view allowlist, query bounds, and metadata-only auditing
independently of agent prompts and PostgreSQL read-only permissions.
